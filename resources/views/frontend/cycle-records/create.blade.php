        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0">Tambah Catatan Siklus Baru</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('cycle-record.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('blood_volume') is-invalid @enderror"
                                ...
                                <option value="normal" {{ old('blood_volume') == 'normal' ? 'selected' : '' }}>Normal</option>
                                <option value="heavy" {{ old('blood_volume') == 'heavy' ? 'selected' : '' }}>Berat</option>
                            </select>
                            @error('blood_volume')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('mood') is-invalid @enderror"
                                ...
                                <option value="tired" {{ old('mood') == 'tired' ? 'selected' : '' }}>Lelah</option>
                            </select>
                            @error('mood')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
