...
@section('style')
<link rel="stylesheet" href="{{ asset('assets/frontend/style/LandingPage/style.css') }}" />
<link rel="stylesheet" href="{{ asset('assets/frontend/style/LandingPage/responsive.css') }}" />
@endsection
...
<section class="main-content3" id="main-content3">
    <div class="container3">
        ...
        <div class="content">
            ...
            <a class="read-more" href="{{ route('article-general') }}">Baca Selengkapnya</a>
